...
//    std::cout << Qwb.coeffs().transpose() <<"\n"<<Qwb.toRotationMatrix() << std::endl;
    ...
    imuGen.testImu("./bin/imu_pose.txt", "./bin/imu_int_pose");     // test the imu data, integrate the imu data to generate the imu trajecotry
    imuGen.testImu("./bin/imu_pose_noise.txt", "./bin/imu_int_pose_noise");
