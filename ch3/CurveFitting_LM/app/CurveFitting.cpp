...
int main()
{
    ...
    vector<double> lamda;
    problem.getlamda(lamda);
    string path="/home/jiangfan/vio_course/ch3/assisignment3/mu2_710.txt";
    ofstream of;
    of.open(path.c_str());
    for(size_t i=0;i<lamda.size();i++)
        of<<i+1<<" "<<lamda[i]<<" "<<endl;
    of.close();
    cout<<"save mu to txt!"<<endl;
